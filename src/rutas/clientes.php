...
$app->get('/api/clientes/{id}', function(Request $request, Response $response){
  ...
  try{
    ...
    if ($resultado->rowCount() > 0){
      ...
      echo json_encode("No existe un cliente registrado con este ID.");
    }
    $resultado = null;
    $db = null;
  }catch(PDOException $e){
...
$app->post('/api/clientes/nuevo', function(Request $request, Response $response){
  ...
  try{
    ...
    $resultado->execute();
    echo json_encode("Cliente guardado satisfactoriamente!");  
...
$app->delete('/api/clientes/delete/{id}', function(Request $request, Response $response){
  ...
  try{
    ...
    if ($resultado->rowCount() > 0) {
      echo json_encode("El cliente fue eliminado satisfactoriamente.");  
    }else {
